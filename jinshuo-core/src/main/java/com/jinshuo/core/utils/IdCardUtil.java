...
public class IdCardUtil {
    ...
    public static Integer getSex(String certificateNo) {
        Integer sexCode =  sexCode = Integer.parseInt(certificateNo.substring(certificateNo.length() - 4, certificateNo.length() - 1)) % 2 == 0 ?  2 : 1;
        return sexCode;
    }

    public static String getBirthday(String certificateNo) {
        String birthday = certificateNo.substring(6, 10) + "-"
    ...
    public static Integer getAge(String certificateNo){
        ...
        Integer age = (year - Integer.parseInt(certificateNo.substring(6, 10)));
        return age;
    }
}
